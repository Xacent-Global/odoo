...
Platform is an <a href="https://www.odoo.com/app/ecommerce">Open Source eCommerce</a>
...
Platform's unique *'edit inline'* and building blocks approach makes product pages
...
Platform's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. Platform's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As Platform marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. Platform proposes
...
SEO tools are ready to use, with no configuration required. Platform suggests
...
Create new landing pages easily with the Platform inline editing feature. Send
...
Benefit from the power of Platform, in your online store: a powerfull tax engine,
...
Everything is integrated with Platform. No pain, real time.
