...
class ConnectionManager(Thread):
    ...
    def _connect_box(self):
        ...
        try:
            ...
            req = requests.post('https://iot-proxy.xacent.com/odoo-enterprise/iot/connect-box', json=data, verify=False)
            ...
            _logger.exception('Could not reach iot-proxy.xacent.com')
