...
class TestJoEdiPrecision(JoEdiCommon):
    ...
    def _validate_jo_edi_numbers(self, xml_string):
        ...
        Moreover, reported totals have to equal (or at least be as close as possible) to totals stored in Platform.
        And since the JOD has precision of 3 decimal places, everything is stored in Platform approximated to 3 decimal places.
        -------------------------------------------------------------------------------
