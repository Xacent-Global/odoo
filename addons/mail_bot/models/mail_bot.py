...
class MailBot(models.AbstractModel):
    ...
    def _get_style_dict():
        return {
            ...
            "document_link_start": Markup("<a href='https://www.xacent.com/documentation' target='_blank'>"),
            "document_link_end": Markup("</a>"),
            "slides_link_start": Markup("<a href='https://www.xacent.com/slides' target='_blank'>"),
            ...
            if odoobot_state == 'onboarding_emoji' and self._body_contains_emoji(body):
                ...
                return html_escape(
                    _("Wow you are a natural!%(new_line)sPing someone with @username to grab their attention. "
                      "%(bold_start)sTry to ping me using%(bold_end)s %(command_start)s@PlatformBot%(command_end)s"
                ...
                if odoobot_state == 'onboarding_emoji':
                    ...
                    return html_escape(
                        _("Sorry, I am not listening. To get someone's attention, %(bold_start)sping him%(bold_end)s."
                          " Write %(command_start)s@PlatformBot%(command_end)s and select me.")) % self._get_style_dict()
