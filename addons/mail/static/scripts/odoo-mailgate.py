...
def main():
    ...
    op.add_option("-d", "--database", dest="database", help="Platform database name (default: %default)", default='odoo')
    op.add_option("-u", "--userid", dest="userid", help="Platform user id to connect with (default: %default)", default=1, type=int)
    op.add_option("-p", "--password", dest="password", help="Platform user password (default: %default)", default='admin')
    op.add_option("--host", dest="host", help="Platform host (default: %default)", default='localhost')
    op.add_option("--port", dest="port", help="Platform port (default: %default)", default=8069, type=int)
