...
test("Show recipient list when there is more than 5 followers.", async () => {
    ...
    const partnerIds = pyEnv["res.partner"].create([
        { name: "test name 1", email: "test1@xacent.com" },
        { name: "test name 2", email: "test2@xacent.com" },
        { name: "test name 3", email: "test3@xacent.com" },
        { name: "test name 4", email: "test4@xacent.com" },
        { name: "test name 5", email: "test5@xacent.com" },
        { name: "test name 6", email: "test6@xacent.com" },
    ]);
    ...
    await contains("li", { text: "test1@xacent.com" });
    await contains("li", { text: "test2@xacent.com" });
    await contains("li", { text: "test3@xacent.com" });
    await contains("li", { text: "test4@xacent.com" });
    await contains("li", { text: "test5@xacent.com" });
    await contains("li", { text: "test6@xacent.com" });
...
test("Show 'No recipient found.' with 0 followers.", async () => {
    const pyEnv = await startServer();
    const partnerId = pyEnv["res.partner"].create({ name: "test name 1", email: "test1@xacent.com" });
    await start();
