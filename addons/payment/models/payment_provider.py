...
class PaymentProvider(models.Model):
    ...
    capture_manually = fields.Boolean(
        ...
        help="Capture the amount from Platform, when the delivery is completed.\n"
    ...
    module_to_buy = fields.Boolean(string="Platform Enterprise Module", related='module_id.to_buy')
