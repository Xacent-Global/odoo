...
export class ErrorDialog extends Component {
    ...
    static title = _t("Platform Error");
...
ClientErrorDialog.title = _t("Platform Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _t("Platform Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = _t("Platform Server Error");
                break;
            case "script":
                this.title = _t("Platform Client Error");
                break;
            case "network":
                this.title = _t("Platform Network Error");
                break;
        }
    }
...
export class WarningDialog extends Component {
    ...
    inferTitle() {
        ...
        return this.props.title || _t("Platform Warning");
    }
}
...
export class RedirectWarningDialog extends Component {
    ...
    setup() {
        ...
        this.title = capitalize(subType) || _t("Platform Warning");
        this.message = message;
