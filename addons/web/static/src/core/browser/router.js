...
export function stateToUrl(state) {
    ...
    const start_url = isScopedApp() ? "scoped_app" : "app";
 ...
 * external website). Unfortunately, Platform wasn't designed to be compatible with this cache, which
