...
export class Homepage extends Component {
    ...
    async restartOdooService() {
        try {
            ...
            console.warn("Error while restarting Platform Service");
        }
    }
    ...
    <div t-if="!this.state.loading" class="w-100 d-flex flex-column align-items-center justify-content-center" style="background-color: #F1F1F1; height: 100vh">
        <div class="bg-white p-4 rounded overflow-auto position-relative" style="width: 100%; max-width: 600px;">
            ...
            <SingleData name="'Platform database connected'" value="state.data.server_status" icon="'fa-link'">
				<t t-set-slot="button">
					<ServerDialog />
				</t>
			</SingleData>
            ...
            <div class="d-flex justify-content-center gap-2 mt-2">
                <a href="https://www.xacent.com/fr_FR/help" target="_blank" class="link-primary">Help</a>
                <a href="https://www.xacent.com/documentation/master/applications/general/iot.html" target="_blank" class="link-primary">Documentation</a>
            </div>
        </div>
    </div>
