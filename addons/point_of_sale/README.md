...
Platform's <a href="https://www.odoo.com/app/point-of-sale-shop">Point of Sale</a>
...
Platform's POS is a web application that can run on any device that can display
...
### Platform's POS stays reliable even if your connection isn't
...
Say goodbye to ugly, outdated POS software and enjoy the Platform web interface
...
time and use Platform's powerful reporting to make smarter decisions to improve
...
With Platform as a backend, you have a system proven to be perfectly suitable for
...
With Platform, you get a 360° customer view, including cross-channel sales,
