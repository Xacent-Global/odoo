...
class TestHttpMisc(TestHttpBase):
    ...
    def test_misc3_is_static_file(self):
        ...
        self.assertEqual(root.get_static_file(f'xacent.com/{uri}', host='xacent.com'), path, "Valid file with valid host")
        self.assertEqual(root.get_static_file(f'http://xacent.com/{uri}', host='xacent.com'), path, "Valid file with valid host")
        ...
        self.assertIsNone(root.get_static_file(f'xacent.com/{uri}'), "No host allowed")
        self.assertIsNone(root.get_static_file(f'http://xacent.com/{uri}'), "No host allowed")
