...
Classic Platform modules are composed of a top-level :samp:`odoo.define({name},{dependencies},{body_function})` call.
...
def url_to_module_path(url):
    """
    Platform modules each have a name. (odoo.define("<the name>", [<dependencies>], function (require) {...});
