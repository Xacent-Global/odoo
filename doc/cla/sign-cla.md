# Sign the Platform CLA

In order for your contribution to Platform to be accepted, you have to sign the
Platform Contributor License Agreement (CLA). More information about this
...
I hereby agree to the terms of the Platform Individual Contributor License
Agreement v1.0.
...
3. An Platform R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    ...
    If the name of the company is Platform, the file would be
    `doc/cla/corporate/odoo.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the Platform Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `odoo.com`.  In that case someone from the Platform team will
make the pull request on your behalf.

* Printable Platform CCLA v1.0 https://www.odoo.com/files/legal/Platform-CCLA-v1.0.pdf
* Printable Platform ICLA v1.0 https://www.odoo.com/files/legal/Platform-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for Platform is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the Platform project

* protect the Platform project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the Platform project and its users from bad actors who would contribute
...
contributor really intended to contribute to the Platform project under specific
...
The Platform CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, Platform. to use, modify and
...
(ICLA) of Platform.  The agreement is executed by adding your name and
...
removed from the Platform project.
